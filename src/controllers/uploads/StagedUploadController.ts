...
const ALLOWED_PURPOSES = new Set<StagedUploadPurpose>(["estimate-pdf", "estimate-attachment", "work-order-attachment", "bid-request-attachment", "bid-proposal-attachment"]);
