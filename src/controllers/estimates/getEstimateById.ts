        ...
        try {
            ...
            return res.status(200).json({
                data: {
                    ...
                    markupValue: estimate.markupValue !== null && estimate.markupValue !== undefined ? Number(estimate.markupValue) : null,
                    markupAmount: estimate.markupAmount !== null && estimate.markupAmount !== undefined ? Number(estimate.markupAmount) : null,
                    ...
                    depositValue: estimate.depositValue !== null && estimate.depositValue !== undefined ? Number(estimate.depositValue) : null,
                    depositAmount: estimate.depositAmount !== null && estimate.depositAmount !== undefined ? Number(estimate.depositAmount) : null,
