...
bidRequestRoutes.get("/categories/:companyId", controller.listRecipientCategories.bind(controller));
bidRequestRoutes.post("/categories/:companyId", controller.createRecipientCategory.bind(controller));
bidRequestRoutes.patch("/categories/:companyId/:categoryId", controller.updateRecipientCategoryDefinition.bind(controller));
...
bidRequestRoutes.patch("/:id/recipients/:recipientId/category", controller.updateRecipientCategory.bind(controller));
