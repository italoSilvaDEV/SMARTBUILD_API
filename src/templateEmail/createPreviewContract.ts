export const createPreviewContract = (
    name: string,
    logo: string,
    company: string, 
    value: number
                                    ...
                                    <table bgcolor="#ffffff" class="bb" align="center" width="600" style="border-collapse: collapse; margin: 0;">
                                        <tr>
                                            <td align="center" bgcolor="#cfebf6" style="padding:30px; margin: 0;">
                                                <p style="font-size:16px;color:#333333;margin:0;text-align:center;"><strong>Your Estimate is ready!</strong></p>
                                    ...
                                    <table bgcolor="#ffffff" class="bb" align="center" width="600" style="border-collapse: collapse; margin: 0;">
                                        <tr>
                                            <td align="center" style="padding:20px; margin: 0;">
                                                ...
                                                <p style="font-size:14px;color:#333333;margin:10px 0 0 0;text-align:center;">We appreciate your business. Find your budget details in the attached file.</p>
