                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background:linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%);border-radius:12px;border:2px solid #10b981;">
                                <tr>
                                    <td align="center" style="padding:28px;">
                                        ...
                                        <p style="font-family:'Inter',-apple-system,BlinkMacSystemFont,'Segoe UI','Helvetica Neue',Arial,sans-serif;font-size:13px;color:#065f46;margin:0 0 4px;font-weight:500;">
                                            Invoice #${invoiceNumber}
                                        </p>
                                        <p style="font-family:'Inter',-apple-system,BlinkMacSystemFont,'Segoe UI','Helvetica Neue',Arial,sans-serif;font-size:12px;color:#10b981;margin:0;font-weight:500;">
                                            via ${formattedPaymentMethod}
                                        </p>
                                    </td>
                                </tr>
                            </table>
