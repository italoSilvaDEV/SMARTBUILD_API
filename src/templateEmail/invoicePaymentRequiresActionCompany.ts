export const invoicePaymentRequiresActionCompany = (
    companyName: string,
    invoiceCode: string, 
...
<head>
    ...
    <title>Payment Verification Required - Invoice ${invoiceCode}</title>
                                ...
                                <table bgcolor="#ffffff" class="bb" align="center" width="600" style="border-collapse: collapse; margin: 0;">
                                    <tr>
                                        <td align="center" bgcolor="#fff3cd" style="padding:30px; margin: 0; border: 1px solid #ffeaa7;">
                                            <p style="font-size:18px;color:#856404;margin:0;text-align:center;font-weight:bold;">Customer Action Required</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                            ...
                                            <div style="font-size:14px;color:#333333;line-height:1.6;text-align:center;max-width:500px;margin:0 auto;">
                                                ...
                                                <div style="background-color:#e7f3ff;border:1px solid #bee5eb;border-radius:5px;padding:15px;margin:20px 0;">
                                                    ...
                                                    <p style="font-size:13px;color:#0c5460;margin:10px 0 0 0;text-align:center;">
                                                        The customer initiated a bank account payment (ACH) that requires verification via microdeposits.<br><br>
                                                        <strong>Next Steps:</strong><br>
                                                        • A $0.01 deposit was sent to the customer's bank account on ${arrivalDate}<br>
                                                        • The customer must verify their bank account by entering a 6-digit code<br>
                                                        • The payment will be processed after verification is completed<br><br>
                                                        An email with detailed instructions was sent to the customer.
                                                    </p>
                                                </div>
                                                
                                                <div style="background-color:#f0f9ff;border:1px solid #38bdf8;border-radius:5px;padding:15px;margin:20px 0;">
                                                    <p style="font-size:14px;color:#0c4a6e;margin:0;text-align:center;font-weight:bold;">🔗 Verification Link</p>
                                                    <p style="font-size:13px;color:#0c4a6e;margin:10px 0 5px 0;text-align:center;">
                                                        If the customer needs the verification link again, you can share it:
                                                    </p>
                                                    <p style="font-size:12px;color:#0369a1;margin:10px 0 0 0;text-align:center;word-break:break-all;">
                                                        <a href="${verificationUrl}" style="color:#0369a1;text-decoration:underline;">${verificationUrl}</a>
                                                    </p>
                                                </div>
                                                ...
                                                <div style="background-color:#ffebee;border:1px solid #f44336;border-radius:5px;padding:15px;margin:20px 0;">
                                                    <p style="font-size:14px;color:#c62828;margin:0;text-align:center;font-weight:bold;">⏰ What This Means</p>
                                                    <p style="font-size:13px;color:#c62828;margin:10px 0 0 0;text-align:center;">
                                                        This is a standard bank verification process for ACH payments.<br>
                                                        The payment is pending until the customer completes verification.<br>
                                                        You will be notified once verification is complete and payment is processed.
                                                    </p>
                                                </div>
                                                
                                                <p style="font-size:12px;color:#888888;margin:20px 0 0 0;text-align:center;font-style:italic;">
                                                    This is an automated notification for internal records.<br>
