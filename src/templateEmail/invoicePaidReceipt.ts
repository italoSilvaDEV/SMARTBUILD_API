export const invoicePaidReceiptEmail = (
    ...
    const emailContent = customBody ? `${customBody}` : `
        ...
        <p style="font-size:14px;color:#333333;margin:10px 0 0 0;text-align:center;">We are sending you the payment receipt for Invoice #${invoiceNumber} that was paid on ${formattedDate}.</p>
        <p style="font-size:14px;color:#333333;margin:10px 0 0 0;text-align:center;">Please find the payment receipt attached to this email for your records.</p>
        ...
        <p style="font-size:14px;color:#333333;margin:10px 0 0 0;text-align:center;">Thank you for your business!</p>
                            ...
                            <tr>
                                <td align="center" style="padding: 0;">
                                    <table bgcolor="#ffffff" class="bb" align="center" width="600" style="border-collapse: collapse; margin: 0;">
                                        <tr>
                                            <td align="center" bgcolor="#e7f3ff" style="padding:30px; margin: 0; border-left: 4px solid #0066cc;">
                                                <p style="font-size:16px;color:#004085;margin:0;text-align:center;"><strong>📄 Invoice #${invoiceNumber} - Payment Receipt</strong></p>
                                                <p style="font-size:14px;color:#004085;margin:10px 0 0 0;text-align:center;"><strong>Invoice Amount: ${formattedAmount}</strong></p>
                                                <p style="font-size:12px;color:#666666;margin:5px 0 0 0;text-align:center;">Payment Date: ${formattedDate}</p>
                                                <p style="font-size:12px;color:#666666;margin:5px 0 0 0;text-align:center;">Status: Paid</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
