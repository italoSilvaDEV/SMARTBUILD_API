export const invoicePaymentConfirmation = (
    clientName: string, 
    companyLogo: string, 
    invoiceCode: string, 
...
<head>
    ...
    <title>Payment Confirmation - Invoice ${invoiceCode}</title>
                        ...
                        <tr>
                            <td align="center" style="padding: 0;">
                                <table bgcolor="#ffffff" class="bb" align="center" width="600" style="border-collapse: collapse; margin: 0;">
                                    <tr>
                                        <td align="center" bgcolor="#d4edda" style="padding:30px; margin: 0; border: 1px solid #c3e6cb;">
                                            <div class="success-icon">✓</div>
                                            <p style="font-size:18px;color:#155724;margin:10px 0 0 0;text-align:center;font-weight:bold;">Payment Successfully Received!</p>
                                            <p style="font-size:16px;color:#155724;margin:10px 0 0 0;text-align:center;">Invoice #${invoiceCode}</p>
                                            <p style="font-size:14px;color:#155724;margin:5px 0 0 0;text-align:center;">Amount: ${formattedValue}</p>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                        ...
                                        <td align="center" style="padding:30px; margin: 0;">
                                            <div style="font-size:14px;color:#333333;line-height:1.6;text-align:center;max-width:500px;margin:0 auto;">
                                                ...
                                                <div style="background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:5px;padding:20px;margin:20px 0;">
                                                    ...
                                                    <p style="font-size:14px;color:#333333;margin:5px 0;text-align:center;"><strong>Status:</strong> <span style="color:#28a745;font-weight:bold;">PAID</span></p>
                                                </div>
                                                
                                                <p style="font-size:14px;color:#333333;margin:20px 0;text-align:center;">
                                                    Thank you for your business and prompt payment. We truly appreciate your trust in our services.
                                                </p>
                                                
                                                <p style="font-size:14px;color:#333333;margin:20px 0;text-align:center;">
                                                    If you have any questions regarding this payment or need any assistance, please don't hesitate to contact us.
                                                </p>
