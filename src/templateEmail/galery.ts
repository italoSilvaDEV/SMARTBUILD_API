export const galleryEmail = (
    ...
    const emailContent = customBody ? `${customBody}` : `
        ...
        <p style="font-size:14px;color:#333333;margin:10px 0 0 0;text-align:center;">We are pleased to share the gallery for your ${serviceName} project.</p>
        <p style="font-size:14px;color:#333333;margin:10px 0 0 0;text-align:center;">Please find the photos and details attached.</p>
        <p style="font-size:14px;color:#333333;margin:10px 0 0 0;text-align:center;">The gallery includes before and after images showcasing the completed work.</p>
        <p style="font-size:14px;color:#333333;margin:10px 0 0 0;text-align:center;">Feel free to contact us if you have any questions or need additional information.</p>
        <p style="font-size:14px;color:#333333;margin:10px 0 0 0;text-align:center;">Thank you for choosing ${company}!</p>
        <p style="font-size:14px;color:#333333;margin:10px 0 0 0;text-align:center;">Best regards,</p>
                                    ...
                                    <table bgcolor="#ffffff" class="bb" align="center" width="600" style="border-collapse: collapse; margin: 0;">
                                        <tr>
                                            <td align="center" bgcolor="#cfebf6" style="padding:30px; margin: 0;">
                                                <p style="font-size:16px;color:#333333;margin:0;text-align:center;"><strong>${serviceName} Gallery is ready!</strong></p>
                                                <p style="font-size:12px;color:#333333;margin:0;text-align:center;">${imageCount} photos included</p>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
