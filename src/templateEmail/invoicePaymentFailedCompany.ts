export const invoicePaymentFailedCompany = (
    companyName: string,
    invoiceCode: string, 
                                        ...
                                        <td align="center" style="padding:30px; margin: 0;">
                                            <div style="font-size:14px;color:#333333;line-height:1.6;text-align:center;max-width:500px;margin:0 auto;">
                                                ...
                                                <div style="background-color:#f8f9fa;border:1px solid #dee2e6;border-radius:5px;padding:20px;margin:20px 0;">
                                                    ...
                                                    <p style="font-size:14px;color:#333333;margin:5px 0;text-align:center;"><strong>Status:</strong> <span style="color:#dc3545;font-weight:bold;">PAYMENT FAILED</span></p>
                                                    ${failureReason ? `<p style="font-size:14px;color:#721c24;margin:10px 0;text-align:center;"><strong>Failure Reason:</strong> ${failureReason}</p>` : ''}
                                                </div>
                                                
                                                <div style="background-color:#fff3cd;border:1px solid #ffeaa7;border-radius:5px;padding:15px;margin:20px 0;">
                                                    <p style="font-size:14px;color:#856404;margin:0;text-align:center;font-weight:bold;">⚠️ Action Required</p>
                                                    <p style="font-size:13px;color:#856404;margin:10px 0 0 0;text-align:center;">
                                                        The customer's payment attempt has failed.<br>
                                                        You may need to follow up with the client or provide alternative payment options.<br>
                                                        Consider contacting the client to resolve any payment issues.
                                                    </p>
                                                </div>
