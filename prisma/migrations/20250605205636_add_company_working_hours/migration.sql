-- AlterTable
ALTER TABLE `Company` ADD COLUMN `workEndTime` VARCHAR(191) NULL,
...
-- CreateIndex
CREATE INDEX `Client_company_id_email_date_creation_idx` ON `Client`(`company_id`, `email`, `date_creation` DESC);
